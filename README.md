...
```xml
<ItemGroup>
    <PackageReference Include="SharpSource" Version="1.33.3" PrivateAssets="All" />
</ItemGroup>
```
...
| SS068  | TimeSpanConstructedWithTicks | `TimeSpan` single-parameter constructor creates ticks (100ns), not seconds. Use `TimeSpan.FromTicks()` to avoid confusion. |
