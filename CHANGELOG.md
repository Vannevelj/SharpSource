...
- `PointlessCollectionToString`, `ThrowNull`, `ExplicitEnumValues`, `SwitchDoesNotHandleAllEnumOptions`, `TestMethodWithoutPublicModifier`, `StructWithoutElementaryMethodsOverridden` and `UnboundedStackalloc` tests use `VerifyCS`
