...
- `ExceptionThrownFromProhibitedContext`, `StaticInitializerAccessedBeforeInitialization`, `SynchronousTaskWait`, `GetHashCodeRefersToMutableMember`, `RecursiveOperatorOverload` and `EnumWithoutDefaultValue` tests use `VerifyCS`
