...
- `ExceptionThrownFromProhibitedContext`, `StaticInitializerAccessedBeforeInitialization`, `GetHashCodeRefersToMutableMember`, `RecursiveOperatorOverload` and `EnumWithoutDefaultValue` tests use `VerifyCS`
